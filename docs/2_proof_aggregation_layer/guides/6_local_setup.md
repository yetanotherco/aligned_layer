# Running the Proof Aggregation Layer locally

This guide walks through running Aligned's Proof Aggregation Service locally: the Gateway that receives proofs, the Payments Poller that credits deposits, and the Proof Aggregator that aggregates proofs and settles them on-chain.
