...
> **CURRENT VERSION:**
> Aligned Operator [v0.20.0](https://github.com/yetanotherco/aligned_layer/releases/tag/v0.20.0)
...
The list of supported strategies can be found [here](../3_guides/8_contract_addresses.md).
