...
> **Archived.** Gnark proofs cannot be submitted to Aligned's Proof Aggregation
> Service, which currently accepts SP1 compressed proofs only. This page is kept
> for reference. See [Generating proofs for Aligned](../../2_proof_aggregation_layer/guides/2_generating_proofs.md).
