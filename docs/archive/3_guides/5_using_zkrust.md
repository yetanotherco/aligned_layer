...
> **Archived.** This guide submits proofs through the deprecated Aligned
> Verification Layer (`zkrust --submit-to-aligned`). It is kept for reference.
> See [Generating proofs for Aligned](../../2_proof_aggregation_layer/guides/2_generating_proofs.md).
