...
Make sure you have Aligned installed as specified [here](../../2_proof_aggregation_layer/guides/1_quickstart.md#quickstart).
...
Learn more about future verifiers [here](../../2_proof_aggregation_layer/architecture/4_supported_verifiers.md).
