# Verification Layer contract addresses

> **Deprecated.** The Aligned Verification Layer is no longer active. These
> addresses are kept for historical reference, and for the archived
> [operator guides](../operator_guides/0_running_an_operator.md).
>
> For the Proof Aggregation Service addresses, see
