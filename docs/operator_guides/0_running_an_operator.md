...
> **CURRENT VERSION:**
> Aligned Operator [v0.15.3](https://github.com/yetanotherco/aligned_layer/releases/tag/v0.15.3)
...
```bash
git clone https://github.com/yetanotherco/aligned_layer.git --branch v0.15.3
cd aligned_layer
```
