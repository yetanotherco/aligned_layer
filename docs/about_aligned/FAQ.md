...
Currently supported ones are Groth 16 and Plonk (gnark), SP1, Halo 2 (IPA and KZG)
...
7. Ethereum verifies the aggregated signatures and changes the state of the batch from pending to verified.
