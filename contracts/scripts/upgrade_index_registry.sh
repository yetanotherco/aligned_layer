...
forge_output=$(forge script script/upgrade/IndexRegistryUpgrader.s.sol \
...
jq --arg new_index_registry_implementation "$new_index_registry_implementation" '.addresses.indexRegistryImplementation = $new_index_registry_implementation' "script/output/holesky/alignedlayer_deployment_output.json" > "script/output/holesky/alignedlayer_deployment_output.temp.json"
