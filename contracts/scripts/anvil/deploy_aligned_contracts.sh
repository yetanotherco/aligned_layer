...
jq '.programs_id.risc0AggregationProgramImageId = $input[0].risc0_root_aggregator_image_id | .programs_id.sp1AggregationProgramVKHash = $input[0].sp1_root_aggregator_vk_hash' \
