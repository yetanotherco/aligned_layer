...
jq --arg new_bls_apk_registry_implementation "$new_bls_apk_registry_implementation" '.addresses.blsApkRegistryImplementation = $new_bls_apk_registry_implementation' "script/output/devnet/alignedlayer_deployment_output.json" > "script/output/devnet/alignedlayer_deployment_output.temp.json"
