...
jq --arg new_stake_registry_implementation "$new_stake_registry_implementation" '.addresses.stakeRegistryImplementation = $new_stake_registry_implementation' "script/output/holesky/alignedlayer_deployment_output.json" > "script/output/holesky/alignedlayer_deployment_output.temp.json"
