...
import (
	...
	generateproof_groth16 "github.com/yetanotherco/aligned_layer/task_sender/test_examples/gnark_groth16_bn254_infinite_script/pkg"
	generateproof_plonk_bn254 "github.com/yetanotherco/aligned_layer/task_sender/test_examples/gnark_plonk_bn254_infinite_script/pkg"
...
func taskSenderInfiniteMain(c *cli.Context) error {
	...
	for {
		...
		switch provingSystem {
		case common.GnarkPlonkBn254:
			generateproof_plonk_bn254.GenerateIneqProof(x)
		case common.Groth16Bn254:
			generateproof_groth16.GenerateIneqProof(x)
		}
