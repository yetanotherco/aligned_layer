...
batcher_send_sp1_task:
	...
	@cd batcher/aligned/ && cargo run --release -- submit \
		--proving_system SP1 \
		--proof ../../scripts/test_examples/sp1/sp1_fibonacci.proof \
		--vm_program ../../scripts/test_examples/sp1/elf \
...
batcher_send_risc0_task:
	...
	@cd batcher/aligned/ && cargo run --release -- submit \
		...
		--proof ../../scripts/test_examples/risc_zero/fibonacci_proof_generator/risc_zero_fibonacci.proof \
        --vm_program ../../scripts/test_examples/risc_zero/fibonacci_proof_generator/fibonacci_id.bin \
		--proof_generator_addr 0x66f9664f97F2b50F62D13eA064982f936dE76657
...
batcher_send_plonk_bn254_task: batcher/target/release/aligned
	...
	@cd batcher/aligned/ && cargo run --release -- submit \
		...
		--proof ../../scripts/test_examples/gnark_plonk_bn254_script/plonk.proof \
		--public_input ../../scripts/test_examples/gnark_plonk_bn254_script/plonk_pub_input.pub \
		--vk ../../scripts/test_examples/gnark_plonk_bn254_script/plonk.vk \
		--proof_generator_addr 0x66f9664f97F2b50F62D13eA064982f936dE76657
...
batcher_send_plonk_bls12_381_task: batcher/target/release/aligned
	...
	@cd batcher/aligned/ && cargo run --release -- submit \
		...
		--proof ../../scripts/test_examples/gnark_plonk_bls12_381_script/plonk.proof \
		--public_input ../../scripts/test_examples/gnark_plonk_bls12_381_script/plonk_pub_input.pub \
		--vk ../../scripts/test_examples/gnark_plonk_bls12_381_script/plonk.vk \
		--proof_generator_addr 0x66f9664f97F2b50F62D13eA064982f936dE76657
...
batcher_send_groth16_bn254_task: batcher/target/release/aligned
	...
	@cd batcher/aligned/ && cargo run --release -- submit \
		...
		--proof ../../scripts/test_examples/gnark_groth16_bn254_infinite_script/infinite_proofs/ineq_1_groth16.proof \
		--public_input ../../scripts/test_examples/gnark_groth16_bn254_infinite_script/infinite_proofs/ineq_1_groth16.pub \
		--vk ../../scripts/test_examples/gnark_groth16_bn254_infinite_script/infinite_proofs/ineq_1_groth16.vk \
		--proof_generator_addr 0x66f9664f97F2b50F62D13eA064982f936dE76657
...
batcher_send_infinite_groth16: batcher/target/release/aligned ## Send a different Groth16 BN254 proof using the client every 3 seconds
	@mkdir -p scripts/test_examples/gnark_groth16_bn254_infinite_script/infinite_proofs
...
batcher_send_halo2_ipa_task: batcher/target/release/aligned
	...
	@cd batcher/aligned/ && cargo run --release -- submit \
		...
		--proof ../../scripts/test_examples/halo2_ipa/proof.bin \
		--public_input ../../scripts/test_examples/halo2_ipa/pub_input.bin \
		--vk ../../scripts/test_examples/halo2_ipa/params.bin \
...
batcher_send_halo2_kzg_task: batcher/target/release/aligned
	...
	@cd batcher/aligned/ && cargo run --release -- submit \
		...
		--proof ../../scripts/test_examples/halo2_kzg/proof.bin \
		--public_input ../../scripts/test_examples/halo2_kzg/pub_input.bin \
		--vk ../../scripts/test_examples/halo2_kzg/params.bin \
		--proof_generator_addr 0x66f9664f97F2b50F62D13eA064982f936dE76657
...
# @cp -r scripts/test_examples/sp1/fibonacci_proof_generator/script/elf scripts/test_examples/sp1/
generate_sp1_fibonacci_proof:
	@cd scripts/test_examples/sp1/fibonacci_proof_generator/script && RUST_LOG=info cargo run --release
	@mv scripts/test_examples/sp1/fibonacci_proof_generator/program/elf/riscv32im-succinct-zkvm-elf scripts/test_examples/sp1/elf
	@mv scripts/test_examples/sp1/fibonacci_proof_generator/script/sp1_fibonacci.proof scripts/test_examples/sp1/
	@echo "Fibonacci proof and ELF generated in scripts/test_examples/sp1 folder"
...
generate_risc_zero_fibonacci_proof:
	@cd scripts/test_examples/risc_zero/fibonacci_proof_generator && \
		RUST_LOG=info cargo run --release && \
		echo "Fibonacci proof and image ID generated in scripts/test_examples/risc_zero folder"
...
generate_halo2_kzg_proof:
	@cd scripts/test_examples/halo2_kzg && \
	cargo clean && \
...
generate_halo2_ipa_proof:
	@cd scripts/test_examples/halo2_ipa && \
	cargo clean && \
	rm params.bin proof.bin pub_input.bin && \
	RUST_LOG=info cargo run --release && \
	echo "Generating halo2 plonk proof..." && \
