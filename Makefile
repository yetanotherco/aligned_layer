...
send-plonkbls12_381-proof: ## Send a PLONK BLS12_381 proof using the task sender
...
send-plonkbls12_381-proof-loop: ## Send a PLONK BLS12_381 proof using the task sender every 10 seconds
...
send-plonkbn254-proof: ## Send a PLONK BN254 proof using the task sender
...
send-plonkbn254-proof-loop: ## Send a PLONK BN254 proof using the task sender every 10 seconds
