...
batcher_send_infinite_sp1:
	...
	@./batcher/client/send_infinite_sp1_tasks/send_infinite_sp1_tasks.sh 10
...
batcher_send_infinite_groth16: ./batcher/client/target/release/aligned ## Send a different Groth16 BN254 proof using the task sender every 3 seconds
	...
	@./batcher/client/send_infinite_tasks.sh 10
...
explorer_fetch_old_batches:
	@cd explorer && \
	./scripts/fetch_old_batches.sh 1728056 1728935