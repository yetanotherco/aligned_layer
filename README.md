...
For submitting proofs generated by your own application reference the documentation on [submitting proofs to Aligned](docs/guides/0_submitting_proofs.md).
