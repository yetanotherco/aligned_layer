...
- [Aligned](#aligned)
  ...
  - [Submitting Proofs to Aligned](docs/guides/0_submitting_proofs.md)
  - [Aligned SDK](docs/guides/1_SDK.md)
...
For submitting proofs generated by your own application please reference the documentation on [submitting proofs to the network](docs/guides/0_submitting_proofs.md).
...
If you are developing applications on Aligned, we offer a [rust SDK](docs/guides/1_SDK.md) for directly submitting proofs to Aligned within your applications. 
