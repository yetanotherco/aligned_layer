...
If you are developing applications using Aligned, we offer a [Rust-SDK](docs/3_guides/1_SDK_how_to) for submitting proofs directly to the network within your applications.
