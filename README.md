...
If you want to verify your proof in your own contract, use a static call to the Aligned contract. You can use the following [Caller Contract](examples/verify/contract/VerifyBatchInclusionCaller.sol) as an example. The code will look like this:
