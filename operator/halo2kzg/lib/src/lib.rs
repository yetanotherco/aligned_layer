...
mod tests {
    ...
    const PROOF: &[u8] =
        include_bytes!("../../../../scripts/test_examples/halo2_kzg/proof.bin");

    const PROOF_FILE_PATH: &str = "../../../scripts/test_examples/halo2_kzg/proof.bin";

    const PUB_INPUT: &[u8] =
        include_bytes!("../../../../scripts/test_examples/halo2_kzg/pub_input.bin");

    const PUB_INPUT_PATH: &str = "../../../scripts/test_examples/halo2_kzg/pub_input.bin";

    const PARAMS: &[u8] =
        include_bytes!("../../../../scripts/test_examples/halo2_kzg/params.bin");

    const PARAMS_FILE_PATH: &str = "../../../scripts/test_examples/halo2_kzg/params.bin";
