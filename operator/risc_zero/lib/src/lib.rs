...
mod tests {
    ...
    const RECEIPT: &[u8] = include_bytes!("../../../../scripts/test_examples/risc_zero/fibonacci_proof_generator/risc_zero_fibonacci.proof");
    const IMAGE_ID: &[u8] = include_bytes!("../../../../scripts/test_examples/risc_zero/fibonacci_proof_generator/fibonacci_id.bin");
