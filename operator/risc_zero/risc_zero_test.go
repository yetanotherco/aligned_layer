...
func TestFibonacciRiscZeroProofVerifies(t *testing.T) {
	receiptFile, err := os.Open("../../scripts/test_examples/risc_zero/fibonacci_proof_generator/risc_zero_fibonacci.proof")
	if err != nil {
	...
	imageIdFile, err := os.Open("../../scripts/test_examples/risc_zero/fibonacci_proof_generator/fibonacci_id.bin")
	if err != nil {
