...
mod tests {
    ...
    const PROOF: &[u8] =
        include_bytes!("../../../../task_sender/test_examples/halo2_axiom/proof.bin");

    const PROOF_FILE_PATH: &str = "../../../task_sender/test_examples/halo2_axiom/proof.bin";

    const PUB_INPUT: &[u8] =
        include_bytes!("../../../../task_sender/test_examples/halo2_axiom/pub_input.bin");

    const PUB_INPUT_PATH: &str = "../../../task_sender/test_examples/halo2_axiom/pub_input.bin";

    const PARAMS: &[u8] =
        include_bytes!("../../../../task_sender/test_examples/halo2_axiom/params.bin");

    const PARAMS_FILE_PATH: &str = "../../../task_sender/test_examples/halo2_axiom/params.bin";
