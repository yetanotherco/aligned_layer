...
mod tests {
    ...
    const RECEIPT: &[u8] = include_bytes!("../../../../scripts/test_files/risc_zero/risc_zero_fibonacci_old.proof");
    const IMAGE_ID: &[u8] = include_bytes!(
        "../../../../scripts/test_files/risc_zero/fibonacci_id_old.bin"
    );
    const PUBLIC_INPUT: &[u8] = include_bytes!(
        "../../../../scripts/test_files/risc_zero/risc_zero_fibonacci_old.pub"
    );
